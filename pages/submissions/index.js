    ...
    return (
        <>
            ...
            <div className="h-screen">
                <h1 className="w-4/6 text-5xl md:text-6xl leading-normal mb-5 font-bold tracking-wide text-purple-500">
                    Submissions
                </h1>
                <Button
                    hoverStyling="hover:bg-purple-400 mb-7"
                ...
                <Button
                    ...
                    onBack={sortSubmissions}
                />
                <List
                    data={submissions}
                    dataType="submissions"
                    hoverStyling="hover:bg-purple-400"
                />
            </div>
        </>
    );
