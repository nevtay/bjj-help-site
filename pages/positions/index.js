...
const Positions = (props) => {
    ...
    return (
        <>
            ...
            <div>
                <h1 className="text-5xl md:text-6xl leading-normal mb-5 font-bold tracking-wide text-yellow-500">
                    Positions
                </h1>
                <Button
                    hoverStyling="hover:bg-orange-400 mb-7"
                ...
                <Button
                    ...
                    onBack={sortPositions}
                />
                <List
                    data={positions}
                    dataType="positions"
                    hoverStyling="hover:bg-orange-400"
                />
            </div>
        </>
    );
